...
const Contact = () => {
  return (
    <div name="contact" className='bg-gradient-to-b from-black to-gray-800 w-full h-full text-white p-4'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/5bb353b9-3472-4728-8765-d646d427c25c" method="POST" className='flex flex-col w-full md:w-1/2'>
                    <input 
                    type="text" 
                    name="name" 
